...
public class JDBCConnection implements ObjectStoreConnection {
    ...
    private static final String SQL_INSERT_SERVICE = "INSERT INTO service "
            ...
            + "x509_cert_signer_keyid, ssh_cert_signer_keyid, client_id, feature_flags) VALUES (?,?,?,?,?,?,?,?,?,?,?);";
    private static final String SQL_UPDATE_SERVICE = "UPDATE service SET modified=CURRENT_TIMESTAMP(3), "
            ...
            + "x509_cert_signer_keyid=?, ssh_cert_signer_keyid=?, creds=?, client_id=?, feature_flags=? WHERE service_id=?;";
    ...
    @Override
    public List<String> lookupDomainByRole(String roleMember, String roleName) throws ServerResourceException {
    ...
    @Override
    public List<String> lookupDomainByBusinessService(String businessService) throws ServerResourceException {
    ...
    @Override
    public Map<String, String> listDomainsByCloudProvider(String provider) throws ServerResourceException {
    ...
    public boolean deleteDomainTags(String domainName, Set<String> tagsToRemove) throws ServerResourceException {
    ...
    public boolean insertDomainTags(String domainName, Map<String, TagValueList> tags) throws ServerResourceException {
    ...
    public Map<String, TagValueList> getDomainTags(int domainId) throws SQLException {
    ...
    public List<String> lookupDomainByTags(String tagKey, String tagValue) throws ServerResourceException {
    ...
    @Override
    public List<String> listDomainTemplates(String domainName) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<String>> getDomainFromTemplateName(Map<String, Integer> templateNameAndLatestVersion) throws ServerResourceException {
    ...
    @Override
    public List<String> listPrincipals(String domainName) throws ServerResourceException {
    ...
    @Override
    public List<String> listRoles(String domainName) throws ServerResourceException {
    ...
    @Override
    public List<String> listTrustedRolesWithWildcards(String domainName, String roleName, String trustDomainName) throws ServerResourceException {
    ...
    void getStdRoleMembers(int roleId, List<RoleMember> members, final String caller) throws ServerResourceException {
    ...
    void getPendingRoleMembers(int roleId, List<RoleMember> members, final String caller) throws ServerResourceException {
    ...
    @Override
    public List<RoleMember> listRoleMembers(String domainName, String roleName, Boolean pending) throws ServerResourceException {
    ...
    @Override
    public List<RoleAuditLog> listRoleAuditLogs(String domainName, String roleName) throws ServerResourceException {
    ...
    @Override
    public List<String> listPolicies(String domainName, String assertionRoleName) throws ServerResourceException {
    ...
    @Override
    public List<String> listPolicyVersions(String domainName, String policyName) throws ServerResourceException {
    ...
    @Override
    public List<Assertion> listAssertions(String domainName, String policyName, String version) throws ServerResourceException {
    ...
    ServiceIdentity saveServiceIdentitySettings(final String domainName, final String serviceName,
        ...
        return new ServiceIdentity()
                ...
                .setClientId(saveValue(rs.getString(JDBCConsts.DB_COLUMN_CLIENT_ID)))
                .setFeatureFlags(nullIfDefaultValue(rs.getInt(JDBCConsts.DB_COLUMN_FEATURE_FLAGS), 0))
    ...
    public boolean insertServiceIdentity(String domainName, ServiceIdentity service) throws ServerResourceException {
        ...
        try (PreparedStatement ps = con.prepareStatement(SQL_INSERT_SERVICE)) {
            ...
            ps.setString(10, processInsertValue(service.getClientId()));
            ps.setInt(11, processInsertValue(service.getFeatureFlags()));
            affectedRows = executeUpdate(ps, caller);
        } catch (SQLException ex) {
            throw sqlError(ex, caller);
        }
    ...
    public boolean updateServiceIdentity(String domainName, ServiceIdentity service) throws ServerResourceException {
        ...
        try (PreparedStatement ps = con.prepareStatement(SQL_UPDATE_SERVICE)) {
            ...
            ps.setString(9, processInsertValue(service.getClientId()));
            ps.setInt(10, processInsertValue(service.getFeatureFlags()));
    ...
    @Override
    public List<String> listServiceIdentities(String domainName) throws ServerResourceException {
    ...
    @Override
    public List<PublicKeyEntry> listPublicKeys(String domainName, String serviceName) throws ServerResourceException {
    ...
    @Override
    public List<String> listServiceHosts(String domainName, String serviceName) throws ServerResourceException {
    ...
    @Override
    public List<String> listEntities(String domainName) throws ServerResourceException {
    ...
    void addTagsToPolicies(Map<Integer, Policy> policyMap, String domainName) throws ServerResourceException {
        ...
        if (domainPolicyTags != null) {
            for (Map.Entry<Integer, Policy> policyEntry : policyMap.entrySet()) {
                Map<String, TagValueList> policyTag = domainPolicyTags.get(Utils.extractPolicyName(domainName, policyEntry.getValue().name) + ":" + policyEntry.getValue().getVersion());
                if (policyTag != null) {
    ...
    Map<String, Map<String, TagValueList>> getDomainPolicyTags(String domainName) throws ServerResourceException {
    ...
    @Override
    public boolean insertPolicyTags(String policyName, String domainName, Map<String, TagValueList> policyTags, String version) throws ServerResourceException {
    ...
    @Override
    public boolean deletePolicyTags(String policyName, String domainName, Set<String> tagKeys, String version) throws ServerResourceException {
    ...
    @Override
    public Map<String, TagValueList> getPolicyTags(String domainName, String policyName, String version) throws ServerResourceException {
    ...
    Map<String, List<Assertion>> getRoleAssertions(String action, String caller) throws ServerResourceException {
    ...
    Set<String> getRolePrincipals(final String principalName, final String caller) throws ServerResourceException {
    ...
    Set<String> getGroupsForPrincipal(final String principalName, final String caller) throws ServerResourceException {
    ...
    Set<String> getRolesForPrincipal(final String principalName, final String caller) throws ServerResourceException {
    ...
    Map<String, List<String>> getTrustedRoles(String caller) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<DomainGroupMember>> getPendingDomainGroupMembersByPrincipal(String principal) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<DomainGroupMember>> getPendingDomainGroupMembersByDomain(String domainName) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<DomainGroupMember>> getExpiredPendingDomainGroupMembers(int pendingGroupMemberLifespan) throws ServerResourceException {
    ...
    @Override
    public Set<String> getPendingGroupMembershipApproverRoles(String server, long timestamp) throws ServerResourceException {
    ...
    void processPendingMembers(final String domainName, final String query, int principalId,
            Map<String, List<DomainRoleMember>> domainRoleMembersMap, final String caller) throws ServerResourceException {
    ...
    void processPendingGroupMembers(final String domainName, final String query, int principalId,
                                    Map<String, List<DomainGroupMember>> domainGroupMembersMap, final String caller) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<DomainRoleMember>> getPendingDomainRoleMembersByPrincipal(String principal) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<DomainRoleMember>> getPendingDomainRoleMembersByDomain(String domainName) throws ServerResourceException {
    ...
    @Override
    public Set<String> getPendingMembershipApproverRoles(String server, long timestamp) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<DomainRoleMember>> getExpiredPendingDomainRoleMembers(int pendingRoleMemberLifespan) throws ServerResourceException {
    ...
    @Override
    public Map<String, DomainRoleMember> getNotifyTemporaryRoleMembers(String server, long timestamp) throws ServerResourceException {
    ...
    @Override
    public Map<String, DomainRoleMember> getNotifyReviewRoleMembers(String server, long timestamp) throws ServerResourceException {
    ...
    @Override
    public List<TemplateMetaData> getDomainTemplates(String domainName) throws ServerResourceException {
    ...
    @Override
    public List<PrincipalRole> listRolesWithUserAuthorityRestrictions() throws ServerResourceException {
    ...
    @Override
    public List<GroupAuditLog> listGroupAuditLogs(String domainName, String groupName) throws ServerResourceException {
    ...
    void getStdGroupMembers(int groupId, List<GroupMember> members, final String caller) throws ServerResourceException {
    ...
    void getPendingGroupMembers(int groupId, List<GroupMember> members, final String caller) throws ServerResourceException {
    ...
    @Override
    public List<GroupMember> listGroupMembers(String domainName, String groupName, Boolean pending) throws ServerResourceException {
    ...
    @Override
    public List<PrincipalGroup> listGroupsWithUserAuthorityRestrictions() throws ServerResourceException {
    ...
    @Override
    public List<PrincipalMember> getPrincipals(int queriedState) throws ServerResourceException {
    ...
    private void addTagsToRoles(Map<String, Role> roleMap, String domainName) throws ServerResourceException {
    ...
    private void addTagsToServices(Map<String, ServiceIdentity> serviceMap, String domainName) throws ServerResourceException {
    ...
    Map<String, Map<String, TagValueList>> getDomainRoleTags(String domainName) throws ServerResourceException {
    ...
    @Override
    public Map<String, TagValueList> getRoleTags(String domainName, String roleName) throws ServerResourceException {
    ...
    @Override
    public boolean insertRoleTags(String roleName, String domainName, Map<String, TagValueList> roleTags) throws ServerResourceException {
    ...
    @Override
    public boolean deleteRoleTags(String roleName, String domainName, Set<String> tagKeys) throws ServerResourceException {
    ...
    @Override
    public boolean insertServiceTags(String serviceName, String domainName, Map<String, TagValueList> serviceTags) throws ServerResourceException {
    ...
    @Override
    public boolean deleteServiceTags(String serviceName, String domainName, Set<String> tagKeys) throws ServerResourceException {
    ...
    @Override
    public Map<String, TagValueList> getServiceTags(String domainName, String serviceName) throws ServerResourceException {
    ...
    private void addTagsToGroups(Map<String, Group> groupMap, String domainName) throws ServerResourceException {
    ...
    Map<String, Map<String, TagValueList>> getServiceResourceTags(String domainName) throws ServerResourceException {
    ...
    Map<String, Map<String, TagValueList>> getDomainGroupTags(String domainName) throws ServerResourceException {
    ...
    @Override
    public Map<String, TagValueList> getGroupTags(String domainName, String groupName) throws ServerResourceException {
    ...
    @Override
    public boolean insertGroupTags(String groupName, String domainName, Map<String, TagValueList> groupTags) throws ServerResourceException {
    ...
    @Override
    public boolean deleteGroupTags(String groupName, String domainName, Set<String> tagKeys) throws ServerResourceException {
    ...
    @Override
    public List<AssertionCondition> getAssertionConditions(long assertionId) throws ServerResourceException {
    ...
    @Override
    public List<String> listServiceDependencies(String domainName) throws ServerResourceException {
    ...
    @Override
    public List<String> listDomainDependencies(String service) throws ServerResourceException {
    ...
    @Override
    public List<ExpiryMember> getAllExpiredRoleMembers(int limit, int offset, int serverPurgeExpiryDays) throws ServerResourceException {
    ...
    @Override
    public List<ExpiryMember> getAllExpiredGroupMembers(int limit, int offset, int serverPurgeExpiryDays) throws ServerResourceException {
    ...
    @Override
    public Map<String, List<String>> listContactDomains(String username) throws ServerResourceException {
    ...
    public Map<String, String> getDomainContacts(int domainId) throws SQLException {
