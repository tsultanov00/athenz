...
public class JDBCConnectionTest {
    ...
    public void testGetDomain() throws Exception {
        ...
        Mockito.doReturn("my-domain").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_ENABLED);
        Mockito.doReturn(false).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        ...
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_AZURE_TENANT);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_AZURE_CLIENT);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_ID);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_NUMBER);
        Mockito.doReturn("service1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_BUSINESS_SERVICE);
        Mockito.doReturn("tag-key").when(mockResultSet).getString(1);
        Mockito.doReturn("tag-val").when(mockResultSet).getString(2);
        Mockito.doReturn("abcd-1234").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_PRODUCT_ID);
        Mockito.doReturn("production").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_ENVIRONMENT);
        Mockito.doReturn(3).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_FEATURE_FLAGS);
        ...
        Mockito.doReturn("cost-center-1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_COST_CENTER);
        ...
        assertEquals(domain.getCostCenter(), "cost-center-1");
        jdbcConn.close();
    }
    ...
    public void testGetDomainWithAuditEnabled() throws Exception {
        ...
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_ENABLED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_ORG);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_UUID);
        Mockito.doReturn("12345").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_ACCOUNT);
        ...
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_APPLICATION_ID);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_SIGN_ALGORITHM);
        Mockito.doReturn("OnShore").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_AZURE_SUBSCRIPTION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_AZURE_TENANT);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_AZURE_CLIENT);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_ID);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_NUMBER);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_BUSINESS_SERVICE);
        Mockito.doReturn("tag-key").when(mockResultSet).getString(1);
        Mockito.doReturn("tag-val").when(mockResultSet).getString(2);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_PRODUCT_ID);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_ENVIRONMENT);
        ...
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_COST_CENTER);
    ...
    public void testGetDomainAllFields() throws Exception {
        ...
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_ENABLED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn("my own domain").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
    ...
    public void testGetAllExpiredRoleMembers() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AS_ROLE_NAME))
                .thenReturn("role1")
                .thenReturn("role2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AS_PRINCIPAL_NAME))
        ...
        List<ExpiryMember> expectedMembers = jdbcConn.getAllExpiredRoleMembers(500, 0, 180);
    ...
    public void testGetAllExpiredRoleMembersException() throws Exception {
        ...
        try {
            jdbcConn.getAllExpiredRoleMembers(500, 0, 180);
            fail();
        } catch (ServerResourceException ex) {
            assertEquals(ex.getCode(), ServerResourceException.INTERNAL_SERVER_ERROR);
        }
    ...
    public void testGetAllExpiredGroupMembers() throws Exception {
        ...
        List<ExpiryMember> expectedMembers = jdbcConn.getAllExpiredGroupMembers(500, 0, 180);
    ...
    public void testGetAllExpiredGroupMembersException() throws Exception {
        ...
        try {
            jdbcConn.getAllExpiredGroupMembers(500, 0, 180);
            fail();
        } catch (ServerResourceException ex) {
            assertEquals(ex.getCode(), ServerResourceException.INTERNAL_SERVER_ERROR);
        }
    ...
    public void testGetRole() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("role1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_TRUST);
        Mockito.doReturn("ec").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_SIGN_ALGORITHM);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_SELF_SERVE);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn(new java.sql.Timestamp(1454358917)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_LAST_REVIEWED_TIME);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_REVIEW_ENABLED);
        Mockito.doReturn("role1,role2").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_ROLES);
        Mockito.doReturn("notify details").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_DETAILS);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_EXPIRATION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        Mockito.doReturn("user,-home").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_PRINCIPAL_DOMAIN_FILTER);
    ...
    public void testGetRoleWithDueDates() throws Exception {
        ...
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_SELF_SERVE);
        Mockito.doReturn(30).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_MEMBER_EXPIRY_DAYS);
        Mockito.doReturn(40).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_SERVICE_EXPIRY_DAYS);
        Mockito.doReturn(70).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_MEMBER_REVIEW_DAYS);
        Mockito.doReturn(80).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_SERVICE_REVIEW_DAYS);
        Mockito.doReturn(90).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_GROUP_REVIEW_DAYS);
        ...
        Mockito.doReturn("role1,role2").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_ROLES);
        Mockito.doReturn("notify details").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_DETAILS);
        Mockito.doReturn("expiry").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_EXPIRATION);
        Mockito.doReturn("filter").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER);
        Mockito.doReturn("description").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        Mockito.doReturn("user,-home").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_PRINCIPAL_DOMAIN_FILTER);
    ...
    public void testGetRoleWithoutSelfServe() throws Exception {
        ...
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_SIGN_ALGORITHM);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn(false).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_SELF_SERVE);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn(new java.sql.Timestamp(1454358917)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_LAST_REVIEWED_TIME);
        Mockito.doReturn(false).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_REVIEW_ENABLED);
        Mockito.doReturn("role1,role2").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_ROLES);
        Mockito.doReturn("notify details").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_DETAILS);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_EXPIRATION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_PRINCIPAL_DOMAIN_FILTER);
    ...
    public void testGetRoleTrust() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("role1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
        Mockito.doReturn("trust.domain").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_TRUST);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_SIGN_ALGORITHM);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn(new java.sql.Timestamp(1454358917)).when(mockResultSet)
    ...
    public void testInsertRole() throws Exception {
        ...
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(23, false);
        Mockito.verify(mockPrepStmt, times(1)).setInt(24, 0);
        Mockito.verify(mockPrepStmt, times(1)).setString(25, "");
        Mockito.verify(mockPrepStmt, times(1)).setString(26, "");
    ...
    public void testInsertRoleWithDueDates() throws Exception {
        ...
        Role role = new Role().setName("my-domain:role.role1").setAuditEnabled(true)
                ...
                .setMaxMembers(3).setNotifyDetails("notify details");
        ...
        Mockito.verify(mockPrepStmt, times(1)).setInt(24, 0);
        Mockito.verify(mockPrepStmt, times(1)).setString(25, "");
        Mockito.verify(mockPrepStmt, times(1)).setString(26, "notify details");
    ...
    public void testUpdateRole() throws Exception {
        ...
        Mockito.verify(mockPrepStmt, times(1)).setString(24, "notify details");
        Mockito.verify(mockPrepStmt, times(1)).setInt(25, 4);
        jdbcConn.close();
    }
    ...
    public void testUpdateRoleWithTrust() throws Exception {
        ...
        Mockito.verify(mockPrepStmt, times(1)).setInt(22, 0);
        Mockito.verify(mockPrepStmt, times(1)).setString(23, "");
        Mockito.verify(mockPrepStmt, times(1)).setString(24, "");
        Mockito.verify(mockPrepStmt, times(1)).setInt(25, 7);
        jdbcConn.close();
    }
    ...
    public void testGetPolicy() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("policy1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
    ...
    public void testGetServiceIdentity() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("test description").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_EXECUTABLE);
    ...
    public void testListPublicKeys() throws Exception {
        ...
        Mockito.when(mockResultSet.next())
            ...
            .thenReturn(true)
            .thenReturn(false);
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY_ID))
            .thenReturn("zms1.zone1")
            .thenReturn("zms2.zone1")
            .thenReturn("zms3.zone1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY_VALUE))
            .thenReturn("Value1")
            .thenReturn("Value2")
            .thenReturn("Value3");
    ...
    public void testListAssertions() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ROLE))
            .thenReturn("role1")
            .thenReturn("role2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_RESOURCE))
            .thenReturn("my-domain:*")
            .thenReturn("my-domain:service.*");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ACTION))
            .thenReturn("*")
            .thenReturn("read");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_EFFECT))
            .thenReturn("ALLOW")
            .thenReturn("DENY");
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_ASSERT_ID))
                .thenReturn(11)
                .thenReturn(12);
    ...
    public void testListAssertionsWithAssertionConditions() throws Exception {
        ...
        Mockito.when(mockResultSet.getLong(JDBCConsts.DB_COLUMN_ASSERT_ID))
                .thenReturn((long) assertionId1)
                .thenReturn((long) assertionId2);
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY))
                .thenReturn("key1")
                .thenReturn("key2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_OPERATOR))
                .thenReturn("EQUALS")
                .thenReturn("EQUALS");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_VALUE))
                .thenReturn("value1")
                .thenReturn("value2");
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_CONDITION_ID))
                .thenReturn(1)
                .thenReturn(2);
    ...
    public void testDeleteServiceTagsExceptions() throws Exception {
        ...
        try {
            ...
            assertEquals(e.getMessage(), "unknown domain - domain");
        }
        ...
        try {
            ...
            assertEquals(e.getCode(), 404);
            assertEquals(e.getMessage(), "unknown service - domain.service");
        }
        try {
            jdbcConn.deleteServiceTags("service", "domain", tagKeys);
            fail();
        } catch (ServerResourceException e) {
            assertEquals(e.getMessage(), "null, state: null, code: 0");
        }
    ...
    public void testGetEntity() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("{\"value\":1}").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_VALUE);
    ...
    public void testInsertPrincipalAlreadyExistsWithDeadlock() throws Exception {
        ...
        try {
            ...
            assertEquals(ex.getCode(), ServerResourceException.CONFLICT);
        }
        jdbcConn.close();
    }
    ...
    public void testListModifiedDomains() throws Exception {
        ...
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DESCRIPTION)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ORG)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_UUID)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DESCRIPTION)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_SIGN_ALGORITHM)).thenReturn("rsa");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_CERT_DNS_DOMAIN)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_APPLICATION_ID)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NOTIFY_ROLES)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NOTIFY_DETAILS)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_SUBSCRIPTION)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_TENANT)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_CLIENT)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_ID)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_NUMBER)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_BUSINESS_SERVICE)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_PRODUCT_ID)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ENVIRONMENT)).thenReturn("");
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_COST_CENTER)).thenReturn("");
    ...
    public void testGetAthenzDomain() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_TYPE))
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_PRINCIPAL_GROUP))
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY_ID)).thenReturn("zms1.zone1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY_VALUE)).thenReturn("Value1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY_VALUE)).thenReturn("Value1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_SIGN_ALGORITHM)).thenReturn("rsa");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_CERT_DNS_DOMAIN)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_APPLICATION_ID)).thenReturn("");
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NOTIFY_DETAILS)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_EXPIRATION)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_SUBSCRIPTION)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_TENANT)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_CLIENT)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_ID)).thenReturn("");
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_PRODUCT_ID)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ENVIRONMENT)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_PRINCIPAL_DOMAIN_FILTER)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_X509_CERT_SIGNER_KEYID)).thenReturn("");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_SSH_CERT_SIGNER_KEYID)).thenReturn("");
    ...
    public void testLookupDomainByBusinessService() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true).thenReturn(false);
        Mockito.doReturn("iaas.athenz").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
    ...
    @Test
    public void testListRoleAuditLogs() throws ServerResourceException, SQLException {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ACTION))
            .thenReturn("ADD")
            .thenReturn("DELETE");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_MEMBER))
            .thenReturn("user.member1")
            .thenReturn("user.member2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ADMIN))
            .thenReturn("user.admin1")
            .thenReturn("user.admin2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AUDIT_REF))
            .thenReturn("")
            .thenReturn("audit-ref");
        Mockito.doReturn(new java.sql.Timestamp(1454358916))
            .when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_CREATED);
    ...
    public void testGetRoleAssertions() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NAME))
            ...
            .thenReturn("dom1")
            .thenReturn("dom2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DOMAIN_ID))
            .thenReturn("101")
            .thenReturn("101")
            .thenReturn("102");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ROLE))
    ...
    public void testGetTrustedRoles() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ROLE))
            ...
            .thenReturn("role1")
            .thenReturn("role3");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ASSERT_DOMAIN_ID))
            .thenReturn("101")
            .thenReturn("101")
            .thenReturn("103");
        long now = System.currentTimeMillis();
    ...
    public void testListDomainsByCloudProviderGCP() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NAME))
                ...
                .thenReturn("dom2")
                .thenReturn("dom3");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_GCP_PROJECT_ID))
                .thenReturn("101")
                .thenReturn("102")
                .thenReturn("103");
    ...
    public void testListDomainsByCloudProviderAzure() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NAME))
                ...
                .thenReturn("dom2")
                .thenReturn("dom3");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AZURE_SUBSCRIPTION))
                .thenReturn("101")
                .thenReturn("102")
                .thenReturn("103");
    ...
    @Test
    public void testListResourceAccessRegisteredRolePrincipals() throws Exception {
    ...
    @Test
    public void testListResourceAccessEmptyRoleAssertions() throws Exception {
    ...
    @Test
    public void testListResourceAccess() throws Exception {
    ...
    @Test
    public void testListResourceAccessAws() throws Exception {
    ...
    public void testGetQuota() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn(7).when(mockResultSet).getInt(1); // domain id
        Mockito.doReturn(10).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_ASSERTION);
        Mockito.doReturn(11).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_ROLE);
        Mockito.doReturn(12).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_ROLE_MEMBER);
        Mockito.doReturn(13).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_POLICY);
        Mockito.doReturn(14).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_SERVICE);
        Mockito.doReturn(15).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_SERVICE_HOST);
        Mockito.doReturn(16).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_PUBLIC_KEY);
        Mockito.doReturn(17).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_ENTITY);
        Mockito.doReturn(18).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_SUBDOMAIN);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
    ...
    @Test
    public void testListOverdueReviewRoleMembersInvalidDomain() throws SQLException {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockPrepStmt.executeQuery()).thenThrow(new SQLException("failed operation", "state", 1001));

        try {
            jdbcConn.listOverdueReviewRoleMembers("athenz");
            fail();
        } catch (ServerResourceException ex) {
            assertEquals(ex.getCode(), ServerResourceException.NOT_FOUND);
        }
    ...
    @Test
    public void testListOverdueReviewRoleMembersNoEntries() throws SQLException, ServerResourceException {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(3); // domain id
        ...
        DomainRoleMembers domainRoleMembers = jdbcConn.listOverdueReviewRoleMembers("athenz");
    ...
    @Test
    public void testListDomainRoleMembersInvalidDomain() throws SQLException {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockPrepStmt.executeQuery()).thenThrow(new SQLException("failed operation", "state", 1001));
    ...
    public void testListDomainRoleMembers() throws Exception {
        ...
        assertTrue(verifyDomainRoleMember(members, "user.joe", "admin", "writer"));
        assertTrue(verifyDomainRoleMember(members, "user.jane", "reader"));
        assertTrue(verifyDomainRoleMemberTimestamp(members, "user.joe", "admin",
                Timestamp.fromMillis(1454358916000L), MemberRole::getExpiration));
        jdbcConn.close();
    }
    ...
    @Test
    public void testGetPrincipalRolesDomain() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(1)  // Principal id will be 1
    ...
    public void testGetPrincipalRolesInvalidDomain() throws SQLException {
        ...
        try {
            ...
            assertEquals(ex.getCode(), 404);
            assertEquals(ex.getMessage(), "unknown domain - unknownDomain");
        }
    }
    ...
    public void testGetPrincipalRolesInvalidPrincipal() throws SQLException {
        ...
        try {
            ...
            fail();
        } catch (ServerResourceException exception) {
            assertEquals(exception.getCode(), ServerResourceException.NOT_FOUND);
            assertEquals(exception.getMessage(), "unknown principal - johndoe");
        }
    }
    ...
    public void testGetPrincipalRolesException() throws SQLException {
        ...
        try {
            ...
            assertEquals(exception.getMessage(), "Statement cancelled due to timeout");
        }
    }

    @Test
    public void testGetPrincipalRolesNoRuleMembers() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(1);  // Principal id will be 1
        Mockito.when(mockResultSet.next())
    ...
    public void testGetRoleDefaultAuditEnabledAsNull() throws Exception {
        ...
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.doReturn(false).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_REVIEW_ENABLED);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_ROLES);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NOTIFY_DETAILS);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_EXPIRATION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_USER_AUTHORITY_FILTER);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_DESCRIPTION);
        Mockito.doReturn("").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_PRINCIPAL_DOMAIN_FILTER);
    ...
    public void testConfirmRoleMemberApprove() throws Exception {
        ...
        String pendingState = JDBCConsts.PENDING_REQUEST_ADD_STATE;
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(5) // domain id
                .thenReturn(7) // role id
                .thenReturn(9); // principal id
    ...
    private void testGetNotifyRoleMembers(boolean isRoleExpire) throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_PRINCIPAL_NAME))
                .thenReturn("user.joe")
                .thenReturn("user.joe")
                .thenReturn("user.jane");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ROLE_NAME))
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DOMAIN_NAME))
                ...
                .thenReturn("athenz1")
                .thenReturn("athenz2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NOTIFY_ROLES))
                .thenReturn("")
                .thenReturn("")
                .thenReturn("");
    ...
    public void testGetDomainTemplates() throws Exception {
        Mockito.when(mockResultSet.next())
                ...
                .thenReturn(false);
        Mockito.when(mockResultSet.getInt(1)).thenReturn(5); // domain id
        Mockito.doReturn(12345).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_DOMAIN_ID);
        Mockito.doReturn("vipng").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_TEMPLATE_NAME);
        Mockito.doReturn(100).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_TEMPLATE_VERSION);
    ...
    @Test
    public void testGetPrincipalGroupsNoRuleMembers() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(1);  // Principal id will be 1
        Mockito.when(mockResultSet.next())
    ...
    @Test
    public void testCountAssertionConditions() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true, false);
        Mockito.when(mockResultSet.getInt(1)).thenReturn(5);
    ...
    @Test
    public void testGetAssertionConditions() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true, false);

        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_KEY)).thenReturn("key1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_OPERATOR)).thenReturn("EQUALS");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_VALUE)).thenReturn("value1");
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_CONDITION_ID)).thenReturn(1);
    ...
    @Test
    public void testGetAssertionCondition() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true, false);
    ...
    @Test
    public void testInsertAssertionConditions() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
    ...
    @Test
    public void testDeleteAssertionConditions() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
    ...
    @Test
    public void testDeleteAssertionCondition() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
    ...
    @Test
    public void testGetNextAssertionCondition() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
    ...
    @Test
    public void testGetAthenzDomainPolicies() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true, false, true, false, true, false);

        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_NAME)).thenReturn("pol1");
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);

        Mockito.when(mockResultSet.getString(1)).thenReturn("pol1");

        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ROLE)).thenReturn("role1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_RESOURCE)).thenReturn("dom1:*");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ACTION)).thenReturn("*");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_EFFECT)).thenReturn("ALLOW");
        Mockito.when(mockResultSet.getLong(JDBCConsts.DB_COLUMN_ASSERT_ID)).thenReturn(1L);
    ...
    public void testGetAthenzDomainPoliciesAssertionConditionsError() throws SQLException {
        ...
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet).getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ROLE)).thenReturn("role1");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_RESOURCE)).thenReturn("resource");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_ACTION)).thenReturn("action");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_EFFECT)).thenReturn("ALLOW");
        Mockito.when(mockResultSet.getLong(JDBCConsts.DB_COLUMN_ASSERT_ID)).thenReturn(1L);
        try {
            // fail to get assertion conditions
    ...
    public void testGetPendingRoleMemberState() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, false);
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.when(mockResultSet.getString(1)).thenReturn(JDBCConsts.PENDING_REQUEST_ADD_STATE);
        ...
        Assert.assertEquals(pendingState, JDBCConsts.PENDING_REQUEST_ADD_STATE);
...
//        Mockito.doThrow(SQLException.class).when(mockConn).prepareStatement(ArgumentMatchers.isA(String.class));
    ...
    public void testDeleteGroupTagsExceptions() throws Exception {
        ...
        try {
            ...
            assertEquals(e.getCode(), 404);
            assertEquals(e.getMessage(), "unknown group - domain:group.group");
        }
        try {
            jdbcConn.deleteGroupTags("group", "domain", tagKeys);
            fail();
    ...
    public void testDeletePolicyTagsExceptions() throws Exception {
        ...
        try {
            ...
            assertEquals(e.getCode(), 404);
            assertEquals(e.getMessage(), "unknown policy - domain:policy.policy");
        }
        try {
            jdbcConn.deletePolicyTags("policy", "domain", tagKeys, any());
            fail();
    ...
    @Test
    public void testGetRolesForReview() throws Exception {
        ...
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DOMAIN_NAME)).thenReturn("domain1").thenReturn("domain2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AS_ROLE_NAME)).thenReturn("role1").thenReturn("role2");
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_MEMBER_EXPIRY_DAYS)).thenReturn(11).thenReturn(12);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_SERVICE_EXPIRY_DAYS)).thenReturn(21).thenReturn(22);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_GROUP_EXPIRY_DAYS)).thenReturn(31).thenReturn(32);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_MEMBER_REVIEW_DAYS)).thenReturn(41).thenReturn(42);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_SERVICE_REVIEW_DAYS)).thenReturn(51).thenReturn(52);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_GROUP_REVIEW_DAYS)).thenReturn(61).thenReturn(62);
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_LAST_REVIEWED_TIME))
                .thenReturn(new java.sql.Timestamp(101)).thenReturn(null);
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_CREATED))
    ...
    @Test
    public void testGetGroupsForReview() throws Exception {

        // first result set is for principal id lookup
        Mockito.when(mockResultSet.next()).thenReturn(true).thenReturn(true).thenReturn(true).thenReturn(false);
        Mockito.when(mockResultSet.getInt(1)).thenReturn(10); // for principal id
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DOMAIN_NAME)).thenReturn("domain1").thenReturn("domain2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AS_GROUP_NAME)).thenReturn("group1").thenReturn("group2");
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_MEMBER_EXPIRY_DAYS)).thenReturn(11).thenReturn(12);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_SERVICE_EXPIRY_DAYS)).thenReturn(21).thenReturn(22);
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_LAST_REVIEWED_TIME))
                .thenReturn(new java.sql.Timestamp(101)).thenReturn(null);
    ...
    @Test
    public void testGetSelfServeRoles() throws Exception {

        Mockito.when(mockResultSet.next()).thenReturn(true).thenReturn(true).thenReturn(false);
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DOMAIN_NAME)).thenReturn("domain1").thenReturn("domain2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_AS_ROLE_NAME)).thenReturn("role1").thenReturn("role2");
        Mockito.when(mockResultSet.getString(JDBCConsts.DB_COLUMN_DESCRIPTION)).thenReturn("desc1").thenReturn("desc2");
        Mockito.when(mockResultSet.getBoolean(JDBCConsts.DB_COLUMN_SELF_RENEW)).thenReturn(true).thenReturn(false);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_SELF_RENEW_MINS)).thenReturn(30).thenReturn(0);
    ...
    @Test
    public void testGetSelfServeGroups() throws Exception {
        ...
        Mockito.when(mockResultSet.getBoolean(JDBCConsts.DB_COLUMN_SELF_RENEW)).thenReturn(true);
        Mockito.when(mockResultSet.getInt(JDBCConsts.DB_COLUMN_SELF_RENEW_MINS)).thenReturn(60);
    ...
    @Test
    public void testGetSelfServeRolesMembershipOverlay() throws Exception {
        ...
        Mockito.when(mockResultSet.getObject(JDBCConsts.DB_COLUMN_AS_PENDING_PRINCIPAL))
                .thenReturn(null, null, Integer.valueOf(7), null);
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_AS_MEMBER_EXPIRATION))
                .thenReturn(new java.sql.Timestamp(200));
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_AS_INHERITED_EXPIRATION))
                .thenReturn(new java.sql.Timestamp(300));
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_AS_PENDING_EXPIRATION))
                .thenReturn(new java.sql.Timestamp(400));
        ...
        assertEquals(objects.get(0).getMemberStatus(), "member");
        assertEquals(objects.get(0).getExpiration(), Timestamp.fromMillis(200));
        assertNull(objects.get(0).getInheritedFrom());

        assertEquals(objects.get(1).getMemberStatus(), "member");
        assertEquals(objects.get(1).getInheritedFrom(), "d:group.eng");
        assertEquals(objects.get(1).getExpiration(), Timestamp.fromMillis(300));

        assertEquals(objects.get(2).getMemberStatus(), "pending");
        assertEquals(objects.get(2).getExpiration(), Timestamp.fromMillis(400));
    ...
    @Test
    public void testGetSelfServeGroupsWithPrincipal() throws Exception {

        // the first result set row resolves the principal id, the main query then
        // returns no rows; memberOnly=true exercises the group filter clause
    ...
    public void testListDomainGroupMembers() throws Exception {
        ...
        assertTrue(verifyDomainGroupMember(members, "user.joe", "admin", "writer"));
        assertTrue(verifyDomainGroupMember(members, "user.jane", "reader"));
        assertTrue(verifyDomainGroupMemberTimestamp(members, "user.joe", "admin",
    ...
    boolean verifyDomainGroupMember(List<DomainGroupMember> members, String memberName, String... groups) {
    ...
    boolean verifyDomainGroupMemberTimestamp(List<DomainGroupMember> members,
    ...
    boolean verifyDomainRoleMember(List<DomainRoleMember> members, String memberName, String... roles) {
    ...
    boolean verifyDomainRoleMemberTimestamp(List<DomainRoleMember> members,
    ...
    public void testInsertGroup() throws Exception {
        ...
        Group group = new Group().setName("my-domain:group.group1").setAuditEnabled(true)
                .setDeleteProtection(true).setMaxMembers(5).setMemberExpiryDays(30)
                .setNotifyDetails("notify-details").setNotifyRoles("role").setPrincipalDomainFilter("domain")
                .setReviewEnabled(true).setResourceOwnership(new ResourceGroupOwnership().setObjectOwner("TF"))
                .setSelfRenew(true).setSelfRenewMins(10).setSelfServe(true).setServiceExpiryDays(50)
                .setUserAuthorityExpiration("user-expiration").setUserAuthorityFilter("user-filter");

        Mockito.doReturn(1).when(mockPrepStmt).executeUpdate();
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn(5).when(mockResultSet).getInt(1); // return domain id

        boolean requestSuccess = jdbcConn.insertGroup("my-domain", group);
        assertTrue(requestSuccess);

        Mockito.verify(mockPrepStmt, times(1)).setString(1, "my-domain");
        Mockito.verify(mockPrepStmt, times(1)).setString(1, "group1");
        Mockito.verify(mockPrepStmt, times(1)).setInt(2, 5);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(3, true);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(4, true);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(5, true);
        Mockito.verify(mockPrepStmt, times(1)).setString(6, "role");
        Mockito.verify(mockPrepStmt, times(1)).setString(7, "user-filter");
        Mockito.verify(mockPrepStmt, times(1)).setString(8, "user-expiration");
        Mockito.verify(mockPrepStmt, times(1)).setInt(9, 30);
        Mockito.verify(mockPrepStmt, times(1)).setInt(10, 50);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(11, true);
        Mockito.verify(mockPrepStmt, times(1)).setTimestamp(12, null);
        Mockito.verify(mockPrepStmt, times(1)).setInt(13, 5);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(14, true);
        Mockito.verify(mockPrepStmt, times(1)).setInt(15, 10);
        Mockito.verify(mockPrepStmt, times(1)).setString(16, "domain");
        Mockito.verify(mockPrepStmt, times(1)).setString(17, "notify-details");
    ...
    public void testUpdateGroup() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.when(mockResultSet.getInt(1)).thenReturn(5) // return domain id
                .thenReturn(4); //group id
        boolean requestSuccess = jdbcConn.updateGroup("my-domain", group);
        assertTrue(requestSuccess);

        Mockito.verify(mockPrepStmt, times(1)).setString(1, "my-domain");
        Mockito.verify(mockPrepStmt, times(1)).setInt(1, 5);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(1, true);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(2, true);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(3, true);
        Mockito.verify(mockPrepStmt, times(1)).setString(4, "role");
        Mockito.verify(mockPrepStmt, times(1)).setString(5, "user-filter");
        Mockito.verify(mockPrepStmt, times(1)).setString(6, "user-expiration");
        Mockito.verify(mockPrepStmt, times(1)).setInt(7, 30);
        Mockito.verify(mockPrepStmt, times(1)).setInt(8, 50);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(9, true);
        Mockito.verify(mockPrepStmt, times(1)).setTimestamp(10, null);
        Mockito.verify(mockPrepStmt, times(1)).setInt(11, 5);
        Mockito.verify(mockPrepStmt, times(1)).setBoolean(12, true);
        Mockito.verify(mockPrepStmt, times(1)).setInt(13, 10);
        Mockito.verify(mockPrepStmt, times(1)).setString(14, "domain");
        Mockito.verify(mockPrepStmt, times(1)).setString(15, "notify-details");
    ...
    public void testGetGroup() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("group1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_AUDIT_ENABLED);
        Mockito.doReturn(true).when(mockResultSet).getBoolean(JDBCConsts.DB_COLUMN_SELF_SERVE);
        Mockito.doReturn(new java.sql.Timestamp(1454358916)).when(mockResultSet)
                .getTimestamp(JDBCConsts.DB_COLUMN_MODIFIED);
        ...
        assertNull(group.getUserAuthorityExpiration());
        assertNull(group.getUserAuthorityFilter());
        assertEquals(group.getNotifyRoles(), "role1,role2");
        assertTrue(group.getReviewEnabled());
        assertEquals(group.getLastReviewedDate(), Timestamp.fromMillis(1454358917));
        assertEquals(group.getPrincipalDomainFilter(), "user,-home");
        assertEquals(group.getNotifyDetails(), "notify details");
    ...
    @Test
    public void testGetGroupMemberYes() throws Exception {
        ...
        GroupMembership membership = jdbcConn.getGroupMember("my-domain", "group1", "user.user1", 0, false);
        ...
        assertEquals(membership.getMemberName(), "user.user1");
        assertEquals(membership.getGroupName(), "my-domain:group.group1");
        assertTrue(membership.getIsMember());
        assertTrue(membership.getApproved());
        jdbcConn.close();
    }
    ...
    @Test
    public void testGetGroupMemberPendingNoUser() throws Exception {
        ...
        GroupMembership membership = jdbcConn.getGroupMember("my-domain", "group1", "user.user1", 0, true);
    ...
    @Test
    public void testGetGroupMemberYesWithExpirationDate() throws Exception {
        ...
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(5) // domain id
                .thenReturn(7); // group1 id
        long now = System.currentTimeMillis();
        Mockito.when(mockResultSet.getTimestamp(JDBCConsts.DB_COLUMN_EXPIRATION))
                .thenReturn(new java.sql.Timestamp(now));

        GroupMembership membership = jdbcConn.getGroupMember("my-domain", "group1", "user.user1", now, false);
    ...
    @Test
    public void testGetGroupMemberPendingYesWithExpiration() throws Exception {
    ...
    @Test
    public void testGetGroupMemberNo() throws Exception {
    ...
    @Test
    public void testGetGroupMemberInvalidPrincipal() throws Exception {
        ...
        try {
            jdbcConn.getGroupMember("my-domain", "role1", "user1", 0, false);
            fail();
        } catch (ServerResourceException ex) {
            assertEquals(ex.getCode(), ServerResourceException.NOT_FOUND);
        }
    ...
    @Test
    public void testGetGroupMemberException() throws Exception {

        Mockito.when(mockPrepStmt.executeQuery()).thenThrow(new SQLException("failed operation", "state", 1001));

        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        try {
            jdbcConn.getGroupMember("my-domain", "role1", "user.user1", 0, false);
            fail();
        } catch (ServerResourceException ex) {
            assertEquals(ex.getCode(), ServerResourceException.NOT_FOUND);
        }
    ...
    public void testListGroupMembers() throws Exception {
        ...
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1)).thenReturn(5).thenReturn(7); // return domain/group id
        ...
        List<GroupMember> groupMembers = jdbcConn.listGroupMembers("my-domain", "group1", false);
    ...
    @Test
    public void testListGroupMembersInvalidRole() throws Exception {
    ...
    @Test
    public void testListGroupMembersWithPending() throws Exception {
        ...
        Mockito.when(mockResultSet.next())
                ...
                .thenReturn(true) // this one is for group id
                .thenReturn(true) // first std user
                .thenReturn(false) // end of standard group members
                .thenReturn(true) // pending members
                .thenReturn(true)
                .thenReturn(true)
                .thenReturn(false);
        ...
        List<GroupMember> groupMembers = jdbcConn.listGroupMembers("my-domain", "group1", true);
        ...
        assertFalse(groupMembers.get(2).getApproved());
        assertFalse(groupMembers.get(3).getApproved());

        assertNull(groupMembers.get(0).getRequestTime());
        assertNotNull(groupMembers.get(1).getRequestTime());
        assertNotNull(groupMembers.get(2).getRequestTime());
        assertNull(groupMembers.get(3).getRequestTime());

        jdbcConn.close();
    }

    @Test
    public void testGetPendingGroupMembershipApproverRoles() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next())
                .thenReturn(true)//domain id lookup for sys.auth.audit.org
                .thenReturn(true)//domain id lookup for sys.auth.audit.domain
                ...
                .thenReturn(true)//dom1 lookup
                .thenReturn(false)//org loop ends
                .thenReturn(true)//one self serve group found
                .thenReturn(false);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(7) // sys.auth.audit.org domain
                .thenReturn(9) // sys.auth.audit.domain domain
        ...
        Set<String> roles = jdbcConn.getPendingGroupMembershipApproverRoles("localhost", timestamp);
    ...
    @Test
    public void testGetPendingGroupMembershipApproverRolesDomain() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next())
                .thenReturn(true)//domain id lookup for sys.auth.audit.org
                .thenReturn(true)//domain id lookup for sys.auth.audit.domain
    ...
    @Test
    public void testGetPendingGroupMembershipApproverRolesOrgError() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true).thenThrow(new SQLException("sql error"));
        try {
            jdbcConn.getPendingGroupMembershipApproverRoles("localhost", 0L);
            fail();
        } catch (ServerResourceException rx) {
            assertTrue(rx.getMessage().contains("sql error"));
        }
    ...
    @Test
    public void testGetPendingGroupMembershipApproverRolesAuditEnabledError() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true, true, true)
                .thenThrow(new SQLException("sql error"));
        Mockito.when(mockResultSet.getInt(1)).thenReturn(7);
    ...
    @Test
    public void testGetPendingGroupMembershipApproverRolesSelfServeError() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next())
                .thenReturn(true)//domain id lookup for sys.auth.audit.org
                .thenReturn(true)//domain id lookup for sys.auth.audit.domain
    ...
    @Test
    public void testGetPendingDomainGroupMembersList() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(9) // principal id
                .thenReturn(5) // sys.auth.audit.org domain id
        ...
        Mockito.doReturn("domain1", "domain1", "domain1", "domain2", "domain21", "domain21", "domain21", "domain22", "domain21", "domain22", "domain22").when(mockResultSet).getString(1);
        Mockito.doReturn("group1", "group11", "group111", "group2", "group3", "group31", "group311", "group4", "group311", "group4", "group4").when(mockResultSet).getString(2);
        Mockito.doReturn("user.member1", "user.member2", "user.member3", "user.member2", "user.member11", "user.member21", "user.member31", "user.member21", "user.member31", "user.member21", "user.member21").when(mockResultSet).getString(3);
        Mockito.doReturn(new java.sql.Timestamp(1454358916), new java.sql.Timestamp(1454358916), null, null, new java.sql.Timestamp(1454358916), new java.sql.Timestamp(1454358916), null, null, null, null, null).when(mockResultSet).getTimestamp(4);
        ...
        Map<String, List<DomainGroupMember>> domainGroupMembersMap = jdbcConn.getPendingDomainGroupMembersByPrincipal("user.user1");

        Mockito.verify(mockPrepStmt, times(1)).setString(1, "user.user1");
        Mockito.verify(mockPrepStmt, times(1)).setString(1, "sys.auth.audit.org");
        Mockito.verify(mockPrepStmt, times(1)).setString(1, "sys.auth.audit.domain");
        Mockito.verify(mockPrepStmt, times(3)).setInt(1, 9); // twice for audit enabled groups, one for selfserve groups
        Mockito.verify(mockPrepStmt, times(1)).setInt(2, 5);
        Mockito.verify(mockPrepStmt, times(1)).setInt(2, 7);

        assertNotNull(domainGroupMembersMap);
        assertEquals(domainGroupMembersMap.size(), 4);

        assertNotNull(domainGroupMembersMap.get("domain1"));
        List<DomainGroupMember> domainGroupMembers = domainGroupMembersMap.get("domain1");
        assertNotNull(domainGroupMembers);
        assertEquals(domainGroupMembers.size(), 3);

        assertEquals(domainGroupMembers.get(0).getMemberName(), "user.member1");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getGroupName(), "group1");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getAuditRef(), "required for proj1");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getRequestPrincipal(), "user.req1");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getRequestTime(), Timestamp.fromMillis(1454358916));

        assertEquals(domainGroupMembers.get(1).getMemberName(), "user.member2");
        assertEquals(domainGroupMembers.get(1).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(1).getMemberGroups().get(0).getGroupName(), "group11");
        assertNull(domainGroupMembers.get(1).getMemberGroups().get(0).getAuditRef());
        assertEquals(domainGroupMembers.get(1).getMemberGroups().get(0).getRequestPrincipal(), "user.req1");
        assertEquals(domainGroupMembers.get(1).getMemberGroups().get(0).getRequestTime(), Timestamp.fromMillis(1454358916));

        assertEquals(domainGroupMembers.get(2).getMemberName(), "user.member3");
        assertEquals(domainGroupMembers.get(2).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(2).getMemberGroups().get(0).getGroupName(), "group111");
        assertEquals(domainGroupMembers.get(2).getMemberGroups().get(0).getAuditRef(), "self serve audit-ref");

        assertNotNull(domainGroupMembersMap.get("domain2"));
        domainGroupMembers = domainGroupMembersMap.get("domain2");
        assertNotNull(domainGroupMembers);
        assertEquals(domainGroupMembers.size(), 1);
        assertEquals(domainGroupMembers.get(0).getMemberName(), "user.member2");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getGroupName(), "group2");
        assertNull(domainGroupMembers.get(0).getMemberGroups().get(0).getAuditRef());

        // selfserve groups retrieved using SQL_PENDING_DOMAIN_SELFSERVE_group_MEMBER_LIST
        assertNotNull(domainGroupMembersMap.get("domain21"));
        domainGroupMembers = domainGroupMembersMap.get("domain21");
        assertNotNull(domainGroupMembers);
        assertEquals(domainGroupMembers.size(), 3);

        assertEquals(domainGroupMembers.get(0).getMemberName(), "user.member11");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getGroupName(), "group3");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getAuditRef(), "required for proj 2");

        assertEquals(domainGroupMembers.get(1).getMemberName(), "user.member21");
        assertEquals(domainGroupMembers.get(1).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(1).getMemberGroups().get(0).getGroupName(), "group31");
        assertNull(domainGroupMembers.get(1).getMemberGroups().get(0).getAuditRef());

        assertEquals(domainGroupMembers.get(2).getMemberName(), "user.member31");
        assertEquals(domainGroupMembers.get(2).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(2).getMemberGroups().get(0).getGroupName(), "group311");
        assertEquals(domainGroupMembers.get(2).getMemberGroups().get(0).getAuditRef(), "self serve audit-ref 2");

        assertNotNull(domainGroupMembersMap.get("domain22"));
        domainGroupMembers = domainGroupMembersMap.get("domain22");
        assertNotNull(domainGroupMembers);
        assertEquals(domainGroupMembers.size(), 1);
        assertEquals(domainGroupMembers.get(0).getMemberName(), "user.member21");
        assertEquals(domainGroupMembers.get(0).getMemberGroups().size(), 1);
        assertEquals(domainGroupMembers.get(0).getMemberGroups().get(0).getGroupName(), "group4");
        assertNull(domainGroupMembers.get(0).getMemberGroups().get(0).getAuditRef());
    ...
    @Test
    public void testGetPendingDomainGroupMembersListSqlErrorSelfServe() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(9) // principal id
                .thenReturn(5) // sys.auth.audit.org domain id
    ...
    @Test
    public void testGetPendingDomainGroupMembersListPrincipalNotExists() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(0); // principal id
    ...
    @Test
    public void testGetPendingDomainGroupMembersListSqlError() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(9) // principal id
                .thenReturn(5); // sys.auth.audit.org domain id
    ...
    @Test
    public void testGetDomainStats() throws Exception {
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(100) // domain id
                .thenReturn(1) // role
                .thenReturn(2) // policy
                .thenReturn(3) // entity
                .thenReturn(4) // service
                .thenReturn(5) // group
                .thenReturn(6) // assertions
                .thenReturn(7) // role members
                .thenReturn(8) // group members
                .thenReturn(9) // service hosts
                .thenReturn(10) // public keys
                .thenReturn(11); // subdomain prefix count
        Stats stats = jdbcConn.getStats("my-domain");
        assertNotNull(stats);
        assertEquals(stats.getRole(), 1);
        assertEquals(stats.getPolicy(), 2);
        assertEquals(stats.getEntity(), 3);
        assertEquals(stats.getService(), 4);
        assertEquals(stats.getGroup(), 5);
        assertEquals(stats.getAssertion(), 6);
        assertEquals(stats.getRoleMember(), 7);
        assertEquals(stats.getGroupMember(), 8);
        assertEquals(stats.getServiceHost(), 9);
        assertEquals(stats.getPublicKey(), 10);
        assertEquals(stats.getSubdomain(), 11);
    }
    ...
    public void testGetSystemStats() throws Exception {
        ...
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.when(mockResultSet.getInt(1))
                .thenReturn(1) // assertions
                .thenReturn(2) // role
                .thenReturn(3) // role members
                .thenReturn(4) // policy
                .thenReturn(5) // service
                .thenReturn(6) // service host
                .thenReturn(7) // public keys
                .thenReturn(8) // entity
                .thenReturn(9) // domains
                .thenReturn(10) // groups
                .thenReturn(11); // group members
        Stats stats = jdbcConn.getStats(null);
        assertNotNull(stats);
        assertEquals(stats.getAssertion(), 1);
        assertEquals(stats.getRole(), 2);
        assertEquals(stats.getRoleMember(), 3);
        assertEquals(stats.getPolicy(), 4);
        assertEquals(stats.getService(), 5);
        assertEquals(stats.getServiceHost(), 6);
        assertEquals(stats.getPublicKey(), 7);
        assertEquals(stats.getEntity(), 8);
        assertEquals(stats.getSubdomain(), 9);
        assertEquals(stats.getGroup(), 10);
        assertEquals(stats.getGroupMember(), 11);
    }
    ...
    public void testGetPrincipal() throws Exception {
        ...
        JDBCConnection jdbcConn = new JDBCConnection(mockConn, true);
        Mockito.when(mockResultSet.next()).thenReturn(true);
        Mockito.doReturn("user.user1").when(mockResultSet).getString(JDBCConsts.DB_COLUMN_NAME);
        Mockito.doReturn(1).when(mockResultSet).getInt(JDBCConsts.DB_COLUMN_SYSTEM_SUSPENDED);

        PrincipalMember principal = jdbcConn.getPrincipal("user.user1");
