...
public class ZMSSelfServeTest {
    ...
    public void testGetSelfServeRoles() {
        ...
        // a self-service role whose description contains the marker (with a couple
        // of members; review is left disabled so they remain active)
        ...
        // verify the returned metadata is populated
    ...
    public void testGetSelfServeGroups() {
        ...
        // a self-service group whose name contains the marker (with a couple of
        // members; review left disabled so they remain active)
